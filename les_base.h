...
// Swap BigEndian -> LittleEndian
LES_int16 fromLittleEndian16(const LES_int16 input);
LES_uint16 fromLittleEndian16(const LES_uint16 input);

LES_int32 fromLittleEndian32(const LES_int32 input);
LES_uint32 fromLittleEndian32(const LES_uint32 input);
